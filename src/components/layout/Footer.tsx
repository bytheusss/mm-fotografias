      ...
      <Container className="py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-sm text-muted">{SITE.slogan}</p>
            <div className="mt-6 flex items-center gap-4">
              <a
                href={SITE.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="flex size-10 items-center justify-center rounded-sm border border-border text-muted transition-all duration-300 hover:border-primary hover:text-primary"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="text-sm text-muted">{SITE.city}</li>
            </ul>
          </div>
        </div>
