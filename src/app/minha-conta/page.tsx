...
export default async function Page() {
  ...
  const { data: profile } = await supabaseAdmin.from("profiles").select("full_name,phone,role").eq("id", user.id).maybeSingle();
